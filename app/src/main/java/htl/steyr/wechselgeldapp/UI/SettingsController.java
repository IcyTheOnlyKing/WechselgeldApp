package htl.steyr.wechselgeldapp.UI;
    ...
    public class SettingsController extends AppCompatActivity {
        ...
        private String getUserEmail() {
            ...
            return prefs.getString("user_email", "user@example.com"); // Fallback-Wert
        }
        ...
        private UserData getCurrentUserData() {
            SharedPreferences prefs = getSharedPreferences("UserData", MODE_PRIVATE);
            String email = prefs.getString("user_email", getUserEmail());
        ...
        private void saveUserData(UserData userData) {
            ...
            editor.putString("total_amount", String.valueOf(userData.getTotalAmount()));
        ...
        private void createBackupWithPassword(String password) {
            try {
                ...
                String userEmail = getUserEmail(); // E-Mail aus Datenbank laden
